package com.stan.spark.streaming.framework.producer

import com.stan.spark.streaming.practice.bean.CityInfo
import com.stan.spark.streaming.practice.util.{PropertiesUtil, RanOpt, RandomOptions}
